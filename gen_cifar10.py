...
if __name__ == '__main__':
    ...
    parser.add_argument('--cc', type=int, default=5, help='number of classes per client')
    parser.add_argument('--alpha', type=float, default=0.1, help='alpha for dirichlet distribution')
    parser.add_argument('--least_samples', type=int, default=10, help='minimum number of samples per class')
    ...
    # usage: python cifar10.py --nc 30 --dist iid --blc 1 --seed 2048 --cc 5 --alpha 0.1 --least_samples 10 --indir ../datasets/ --outdir ../datasets/
    ...
    map_dict = subset_data(
        dataset_label, num_clients, 10, dist, blc, cc, alpha, least_samples
    )
    # split data
    stats = {}
